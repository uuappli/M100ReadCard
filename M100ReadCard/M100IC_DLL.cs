...
namespace M100ReadCard
{
    ...
    {
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_GetSysVersion", CharSet = CharSet.Ansi)]
        public static extern int M100_GetSysVersion(IntPtr ComHandle, StringBuilder strVersion);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CommOpen", CharSet = CharSet.Ansi)]//打开端口
        public static extern IntPtr M100_CommOpen(string port);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CommOpenWithBaud", CharSet = CharSet.Ansi)]//打开端口（设置固定波特率 默认9600）
        public static extern IntPtr M100_CommOpenWithBaud(string port, int data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CommClose", CharSet = CharSet.Ansi)]//关闭端口
        public static extern int M100_CommClose(IntPtr ComHandle);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Reset", CharSet = CharSet.Ansi)]
        public static extern int M100_Reset(IntPtr ComHandle,byte _PM, byte[] _VerCode);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SetCommBaud", CharSet = CharSet.Ansi)]
        ...
        //=0x35：读卡机内无卡。
        //=0x36：卡不在标准位置
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CheckCardPosition", CharSet = CharSet.Ansi)]
        public static extern int M100_CheckCardPosition(IntPtr ComHandle, byte[] _Position);
            ...
            //KSW =0x30：无卡，=0x31：有卡
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CheckSensorStates", CharSet = CharSet.Ansi)]
        public static extern int M100_CheckSensorStates(IntPtr ComHandle, byte[] _States);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_EnterCard", CharSet = CharSet.Ansi)]
        public static extern int M100_EnterCard(IntPtr ComHandle, byte EnterType, int WaitTime);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_MoveCard", CharSet = CharSet.Ansi)]
        public static extern int M100_MoveCard(IntPtr ComHandle, byte _PM);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_AutoTestICCard", CharSet = CharSet.Ansi)]
        public static extern int M100_AutoTestICCard(IntPtr ComHandle, byte[] _States);


        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_IcCardPowerOn", CharSet = CharSet.Ansi)]
        public static extern int M100_IcCardPowerOn(IntPtr ComHandle);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_IcCardPowerOff", CharSet = CharSet.Ansi)]
        public static extern int M100_IcCardPowerOff(IntPtr ComHandle);


        //SLE4442 卡操作函数
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442Reset", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442Reset(IntPtr ComHandle);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442VerifyPWD", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442VerifyPWD(IntPtr ComHandle, byte[] _PWData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442Read", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442Read(IntPtr ComHandle, int _Address, int _dataLen, byte[] _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442ReadProtectBit", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442ReadProtectBit(IntPtr ComHandle, StringBuilder _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442ReadSafety", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442ReadSafety(IntPtr ComHandle, StringBuilder _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_SLE4442Write", CharSet = CharSet.Ansi)]
        public static extern int M100_SLE4442Write(IntPtr ComHandle, int _Address, int _dataLen, byte[] _BlockData);


        //SLE4428 卡操作函数
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Sle4428Reset", CharSet = CharSet.Ansi)]
        public static extern int M100_Sle4428Reset(IntPtr ComHandle);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Sle4428VerifyPWD", CharSet = CharSet.Ansi)]
        public static extern int M100_Sle4428VerifyPWD(IntPtr ComHandle, byte[] _PWData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Sle4428Read", CharSet = CharSet.Ansi)]
        public static extern int M100_Sle4428Read(IntPtr ComHandle, int _Address, int _dataLen, StringBuilder _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Sle4428ReadProtectBit", CharSet = CharSet.Ansi)]
        public static extern int M100_Sle4428ReadProtectBit(IntPtr ComHandle, StringBuilder _BlockData);

    
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_Sle4428Write", CharSet = CharSet.Ansi)]
        public static extern int M100_Sle4428Write(IntPtr ComHandle, int _Address, int _dataLen, byte[] _BlockData);
        
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_CpuCardColdReset", CharSet = CharSet.Ansi)]
        ...
        //[DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_ReadMagcardDecode", CharSet = CharSet.Ansi)]
        ...
        //[DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_ReadMagcardUNDecode", CharSet = CharSet.Ansi)]
        ...
        //[DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_ClearMagCardData", CharSet = CharSet.Ansi)]
        //public static extern int M100_ClearMagCardData(IntPtr ComHandle, bool bHasMac_Addr, byte Mac_Addr, StringBuilder RecordInfo);

        //射频卡操作
        //S50
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S50DetectCard", CharSet = CharSet.Ansi)]
        ...
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S50InitValue", CharSet = CharSet.Ansi)]
        public static extern int M100_S50InitValue(IntPtr ComHandle, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S50Increment", CharSet = CharSet.Ansi)]
        public static extern int M100_S50Increment(IntPtr ComHandle, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S50Decrement", CharSet = CharSet.Ansi)]
        public static extern int M100_S50Decrement(IntPtr ComHandle, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S50Halt", CharSet = CharSet.Ansi)]
        public static extern int M100_S50Halt(IntPtr ComHandle);

        //S70
        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70DetectCard", CharSet = CharSet.Ansi)]
        public static extern int M100_S70DetectCard(IntPtr ComHandle);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70GetCardID", CharSet = CharSet.Ansi)]
        public static extern int M100_S70GetCardID(IntPtr ComHandle, byte[] _CardID);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70LoadSecKey", CharSet = CharSet.Ansi)]
        public static extern int M100_S70LoadSecKey(IntPtr ComHandle, byte _BlockAddr, byte _KEYType, byte[] _KEY);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70ReadBlock", CharSet = CharSet.Ansi)]
        public static extern int M100_S70ReadBlock(IntPtr ComHandle, byte _Block, byte[] _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70WriteBlock", CharSet = CharSet.Ansi)]
        public static extern int M100_S70WriteBlock(IntPtr ComHandle, byte _Block, byte[] _BlockData);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70InitValue", CharSet = CharSet.Ansi)]
        public static extern int M100_S70InitValue(IntPtr ComHandle, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70Increment", CharSet = CharSet.Ansi)]
        public static extern int M100_S70Increment(IntPtr ComHandle, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70Decrement", CharSet = CharSet.Ansi)]
        public static extern int M100_S70Decrement(IntPtr ComHandle, byte _Sec, byte _Block, byte[] _Data);

        [DllImport("C:/M100_DLL/M100_DLL.dll", EntryPoint = "M100_S70Halt", CharSet = CharSet.Ansi)]
